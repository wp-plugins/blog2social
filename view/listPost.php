                ...
                <?php if (!empty($posts_array)) { ?>
                    <table class="table">
                        ...
                        foreach ($posts_array as $var) {
                            $last_network_publish_date = (isset($var->last_network_publish_date) && $var->last_network_publish_date != '0000-00-00 00:00:00' && !empty($var->last_network_publish_date)) ? date($lang['DATE_FRONTEND'], strtotime($var->last_network_publish_date)) : '';
                            $last_prg_publish_date = (isset($var->last_prg_publish_date) && $var->last_prg_publish_date != '0000-00-00 00:00:00' && !empty($var->last_prg_publish_date)) ? date($lang['DATE_FRONTEND'], strtotime($var->last_prg_publish_date)) : '';
                            ?>
