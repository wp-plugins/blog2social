...
$actions = array('addMandant', 'deleteMandant', 'createMessagePRG', 'loginPRG', 'logoutPRG', 'deleteNetwork', 'checkKey', 'publishDeleteNetwork');

if (!isset($_POST['action']) || !isset($_POST['token']) || !in_array(trim($_POST['action']), $actions) || empty($_POST['token'])) {
