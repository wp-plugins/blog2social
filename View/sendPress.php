            ...
            <fieldset>
                ...
                <div id="leftPublishForm">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-11">                     
                            <textarea id="prg_text" name="message" rows="10" data-provide="markdown" class="form-control" placeholder="<?php echo $text['MSG_TEXT']; ?>"><?php echo trim(strip_shortcodes(strip_tags($page_data->post_content))); ?></textarea>
                        </div>
                    </div>
                    <div class="form-group">
                ...
                <div id="bottomPublishForm">
                    <div id="imgChose" class="col-md-12">
                        ...
                        <div class="col-md-12">
                            <div id="divImg1" class="col-md-2 picList">
                                <label class="col-md-12" for="img0"><img class="imgs" src="<?php echo plugins_url('/images/placeholder.png', dirname(__FILE__)); ?>"></label>
                                <div class="text-center">
                                    <input checked="checked" id="img0" type="radio" name="bild" value="">
                                </div>
                            </div>
                            <?php
                            if (getImagesByPostID($page_data->ID, false)) :
                                $i = 0;
                                ...
                                foreach ($images as $image) :
                                    ...
                                    ?>
                                    <div id="divImg<?php echo $i + 1; ?>" class="col-md-2 picList">
                                        <label class="col-md-12" for="img<?php echo $i + 1; ?>"><img class="imgs" src="<?php echo $image[0]; ?>"></label>
                                        <div class="text-center">
                                            <input class="newImg" id="img<?php echo $i + 1; ?>" type="radio" name="bild" value="<?php echo $image[1]; ?>">
                                        </div>
                                    </div>
                                <?php endforeach; ?>
                            </div>
                    ...
                    <div id="submitDiv">
                        <button type="submit" name="draft" value="1" class="btn btn-success administrative" data-color="primary"><?php echo $text['SAVE_MSG_DRAFT']; ?></button>
