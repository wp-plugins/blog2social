                    ...
                    <div id="myTabContent" class="tab-content">
                        <div id="mandant" class="tab-pane active">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    <input maxlength="10" id="prg_firm_add2" name="nummer_mandant" placeholder="<?php echo $text['NUMBER']; ?>" class="form-control" type="text" value="">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    <input id="prg_firm_pc" name="plz_mandant" maxlength="10" placeholder="<?php echo $text['ZIP']; ?>" class="form-control" type="text" value="">
                                </div>
                                <div class="col-md-9">
                        ...
                        <div id="presse" class="tab-pane">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    <input maxlength="10" id="prg_address2" type="text" name="nummer_presse" value="<?php echo $savedUser->nummer; ?>" placeholder="<?php echo $text['NUMBER']; ?>" class="form-control">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-3"><small><?php echo $text['ZIP']; ?></small></label>
                                <label class="col-md-9"><small><?php echo $text['CITY']; ?></small></label>
                                <div class="col-md-3">
                                    <input maxlength="10" id="prg_pc2" type="text" name="plz_presse" value="<?php echo $savedUser->pc; ?>" placeholder="<?php echo $text['ZIP']; ?>" class="form-control">
                                </div>
                                <div class="col-md-9">
