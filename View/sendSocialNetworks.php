                        ...
                        <div class="col-md-12">
                            <div class="col-md-12">
                                <h3>
                                    ...
                                    <img id="statusDiigoLoading" alt="diigoLoad" src="<?php echo plugins_url('images/ajax-loader.gif', dirname(__FILE__)); ?>" style="display:none;width:30px;">
                        ...
                        <div class="col-md-12">
                            <div class="col-md-12">
                                <h3>
                                    ...
                                    <img id="statusGoogleplusLoading" alt="storifyLoad" src="<?php echo plugins_url('images/ajax-loader.gif', dirname(__FILE__)); ?>" style="display:none;width:30px;">
