...
$shortlink = (get_permalink($_GET['blogid']) !== false) ? get_permalink($_GET['blogid']) : $page_data->guid; 
...
<div>
    <form method="POST" id="prgConnect_sendSocial" name="prgConnect_sendSocial" enctype="multipart/form-data">
        ...
        <input type="hidden" name="shortUrl" id="shortUrl" value="<?php echo $shortlink; ?>">
        <input type="hidden" name="urlForTwit" id="urlForTwit" value="<?php echo $shortlink; ?>">
        <input type="hidden" name="urlForXing" id="urlForXing" value="<?php echo $shortlink; ?>">
