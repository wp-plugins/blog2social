            ...
            <?php if (!empty($facebookName)) { ?>
                <div id="facebookPostArea">
                    <div class="col-md-12">
                        <div class="col-md-12">
                            <h3>
                                <span class="label label-primary administrative-label"><input class="snChecks" checked="checked" id="checkFacebook" type="checkbox" name="checkFacebook" />  Facebook</span>
            ...
            if (!empty($twitterName)) {
                ...
                <div id="twitterPostArea">
                    <div class="col-md-12">
                        <div class="col-md-12">
                            <h3>
                                <span class="label label-primary administrative-label"><input class="snChecks" checked="checked" id="checkTwitter" type="checkbox" name="checkTwitter" /> Twitter</span>
            ...
            if (!empty($linkedinName)) {
                ...
                <div id="linkedinPostArea">
                    <div class="col-md-12">
                        <div class="col-md-12">
                            <h3>
                                <span class="label label-primary administrative-label"><input class="snChecks" checked="checked" id="checkLinkedin" type="checkbox" name="checkLinkedin" /> LinkedIn</span>
            ...
            if (!empty($tumblrName)) {
                ...
                <div id="tumblrPostArea">
                    <div class="col-md-12">
                        <div class="col-md-12">
                            <h3>
                                <span class="label label-primary administrative-label"><input class="snChecks" checked="checked" id="checkTumblr" type="checkbox" name="checkTumblr"> Tumblr</span>
            ...
            if (!empty($storifyName)) {
                ...
                <div id="storifyPostArea">
                    <div class="col-md-12">
                        <div class="col-md-12">
                            <h3>
                                <span class="label label-primary administrative-label"><input class="snChecks" checked="checked" id="checkStorify" type="checkbox" name="checkStorify" /> Storify</span>
            ...
            if (!empty($pinterestName)) {
                ...
                <div id="pinterestPostArea">
                    <div class="col-md-12">
                        <div class="col-md-12">
                            <h3>
                                <span class="label label-primary administrative-label"><input class="snChecks" checked="checked" id="checkPinterest" type="checkbox" name="checkPinterest" /> Pinterest</span>
            ...
            if (!empty($flickrName)) {
                ...
                <div id="flickrPostArea">
                    <div class="col-md-12">
                        <div class="col-md-12">
                            <h3>
                                <span class="label label-primary administrative-label"><input class="snChecks" checked="checked" id="checkFlickr" type="checkbox" name="checkFlickr" /> Flickr</span>
            ...
            if (!empty($xingName)) {
                ...
                <div id="xingPostArea">
                    <div class="col-md-12">
                        <div class="col-md-12">
                            <h3>
                                <span class="label label-primary administrative-label"><input class="snChecks" checked="checked" id="checkXing" type="checkbox" name="checkXing"> Xing</span>
            ...
            if (!empty($diigoName)) {
                ...
                <div id="diigoPostArea">
                    <div class="col-md-12">
                        <div class="col-md-12">
                            <h3>
                                <span class="label label-primary administrative-label"><input class="snChecks" checked="checked" id="checkDiigo" type="checkbox" name="checkDiigo"> Diigo</span>
            ...
            if (!empty($googleplusName)) {
                ...
                <div id="googleplusPostArea">
                    <div class="col-md-12">
                        <div class="col-md-12">
                            <h3>
                                <span class="label label-primary administrative-label"><input class="snChecks" checked="checked" id="checkGoogleplus" type="checkbox" name="checkGoogleplus" /> GooglePlus</span>
