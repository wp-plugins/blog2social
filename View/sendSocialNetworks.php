                ...
                <fieldset>
                    ...
                    <div id="xingPostArea">
                        <div class="col-md-12">
                            <div class="col-md-12">
                                <h3>
                                    <span class="label label-primary administrative-label"><input class="snChecks" <?php echo (empty($xingName)) ? 'disabled="disabled"' : 'checked="checked"' ?> id="checkXing" type="checkbox" name="checkXing"> Xing</span>
                                    ...
                                    <span id="xingStatusSpan" class="hider">
                                        <?php if (empty($xingName)) : ?>
                                            <small><?php echo $text['SETUP_SN'] ?></small>
                                        <?php endif;
                                        ?>
                                    </span>
                        ...
                        <div class="col-md-12 hider">
                            <div class="form-group">
                                <div class="col-md-12">
                                    ...
                                    <textarea <?php echo (empty($xingName)) ? 'readonly="readonly" style="transparent; color: rgb(172, 168, 153); background-color: rgb(235, 235, 228);"' : ''; ?> id="prg_xing" name="prg_xing" class="form-control col-md-11" placeholder="<?php echo $text['MSG_TO_XING']; ?>"><?php echo $page_data->post_title; ?></textarea>
                    ...
                    <div id="diigoPostArea">
                        <div class="col-md-12">
                            <div class="col-md-12">
                                <h3>
                                    <span class="label label-primary administrative-label"><input class="snChecks" <?php echo (empty($diigoName)) ? 'disabled="disabled"' : 'checked="checked"' ?> id="checkDiigo" type="checkbox" name="checkDiigo"> Diigo</span>
                                    ...
                                    <span id="diigoStatusSpan" class="hider">
                                        <?php if (empty($diigoName)) : ?>
                                            <small><?php echo $text['SETUP_SN'] ?></small>
                                        <?php endif;
                                        ?>
                                    </span>
                        ...
                        <div class="col-md-12 hider">
                            <div class="form-group">
                                <div class="col-md-12">
                                    ...
                                    <textarea <?php echo (empty($diigoName)) ? 'readonly="readonly" style="transparent; color: rgb(172, 168, 153); background-color: rgb(235, 235, 228);"' : ''; ?> id="prg_diigo" name="prg_diigo" class="form-control col-md-11" placeholder="<?php echo $text['MSG_TO_DIIGO']; ?>"><?php echo $page_data->post_title; ?></textarea>
                                </div>
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="col-md-12">
                    ...
                    <div id="googleplusPostArea">
                        <div class="col-md-12">
                            <div class="col-md-12">
                                <h3>
                                    <span class="label label-primary administrative-label"><input class="snChecks" <?php echo (empty($googleplusName)) ? 'disabled="disabled"' : 'checked="checked"' ?> id="checkGoogleplus" type="checkbox" name="checkGoogleplus" /> GooglePlus</span>
                        ...
                        <div class="col-md-12 hider">
                            <div class="form-group">
                                <div class="col-md-12">
                                    <textarea <?php echo (empty($googleplusName)) ? 'readonly="readonly" style="transparent; color: rgb(172, 168, 153); background-color: rgb(235, 235, 228);"' : ''; ?> id="prg_googleplus" name="prg_googleplus" class="form-control col-md-11" placeholder="<?php echo $text['MSG_TO_GOOGLEPLUS']; ?>"><?php echo trim(strip_shortcodes(strip_tags($page_data->post_content))); ?></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
