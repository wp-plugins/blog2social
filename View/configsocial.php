...
<table id="Posts" class="configSocialTable table">
    <tr>
        ...
        <td class="socialMeths">
            ...
            if (!empty($facebookName)) {
                ...
                '<br><a href="http://developer.pr-gateway.de/wp/index.php?action=register&type=1&userid=' . substr($savedUser->UserBlogToken, 3) . '" target="_blank" id="SocialNetworkFacebook" class="SocialNetwork connectSocials">' . $text['CHANGE_NETWORK_FACEBOOK'] . '</a>';
            } else {
    ...
    <tr>
        ...
        <td class="socialMeths">
            ...
            if (!empty($pinterestName)) {
                ...
                '<br><a href="http://developer.pr-gateway.de/wp/index.php?action=register&type=6&userid=' . substr($savedUser->UserBlogToken, 3) . '" target="_blank" id="SocialNetworkPinterest" class="SocialNetwork connectSocials">' . $text['CHANGE_NETWORK_PINTEREST'] . '</a>';
            } else {
    ...
    <tr>
        ...
        <td class="socialMeths">
            <?php
            if (!empty($xingName)) {
                echo 'Account: ' . $xingName;
            } else {
                echo '<a href="http://developer.pr-gateway.de/wp/index.php?action=register&type=8&userid=' . substr($savedUser->UserBlogToken, 3) . '" target="_blank" id="SocialNetworkXing" class="SocialNetwork connectSocials">' . $text['CONN_XING'] . '</a>';
            }
            ?>
        </td>
    </tr>
