jQuery(document).ready(function () {
    if (jQuery("#lang").val() == "de") {
        ...
        var validateMessages = {
            ...
            zeichenVerbleibend: "chars remaining"
        };
    }
...
<span id="urlTwit"><a id="aTwit" href="' + jQuery("#urlForTwit").val() + '">' + jQuery("#urlForTwit").val() + '</a></span>';
        ...
        jQuery("#countdownTwit").html(remaining + ' ' + validateMessages['zeichenVerbleibend']);
    });
...
<span id="urlTwit"><a id="aTwit" href="' + jQuery("#urlForTwit").val() + '">' + jQuery("#urlForTwit").val() + '</a></span>';
    ...
    jQuery(document).on("keyup", '#prg_linkedin', function () {
        ...
        jQuery("#countdownLink").html(remaining + ' ' + validateMessages['zeichenVerbleibend']);
    });
    ...
    jQuery(document).on("keyup", '#prg_pinterest', function () {
        ...
        jQuery("#countdownPint").html(remaining + ' ' + validateMessages['zeichenVerbleibend']);
    });
...
<span id="urlXing"><a id="aXing" href="' + jQuery("#urlForXing").val() + '">' + jQuery("#urlForXing").val() + '</a></span>';
        ...
        jQuery("#countdownXing").html(remaining + ' ' + validateMessages['zeichenVerbleibend']);
    });
...
<span id="urlXing"><a id="aXing" href="' + jQuery("#urlForXing").val() + '">' + jQuery("#urlForXing").val() + '</a></span>';
    ...
    jQuery(document).on("keyup", '#prg_diigo', function () {
        var maxChars = 250;
        var remaining;
        ...
        jQuery("#countdownDiigo").html(remaining + ' ' + validateMessages['zeichenVerbleibend']);
    });
    ...
    jQuery("#checkTumblr").change(function () {
        if (jQuery("#checkTumblr:checked").length) {
            ...
            jQuery(".inputTumblrTags").attr("readonly", false);
            jQuery("#tumblrTagAddBtn").show();
        } else {
            jQuery("#prg_tumblr").attr("readonly", true);
            jQuery("#prg_tumblr").css("background-color", "#EBEBE4");
            jQuery("#prg_tumblr").css("color", "#ACA899");
            jQuery(".inputTumblrTags").attr("readonly", true);
            jQuery("#tumblrTagAddBtn").hide();
        }
    });
    ...
    jQuery("#checkDiigo").change(function () {
        if (jQuery("#checkDiigo:checked").length) {
            ...
            jQuery(".inputDiigoTags").attr("readonly", false);
            jQuery("#diigoTagAddBtn").show();
        } else {
            jQuery("#prg_diigo").attr("readonly", true);
            jQuery("#prg_diigo").css("background-color", "#EBEBE4");
            jQuery("#prg_diigo").css("color", "#ACA899");
            jQuery(".inputDiigoTags").attr("readonly", true);
            jQuery("#diigoTagAddBtn").hide();
        }
    });
    ...
    jQuery("#prgConnect_sendSocial").validate({
            ...
            prg_twitter: {
                rangelength: function () {
                    if (document.prgConnect_sendSocial.checkTwitter.checked == true) {
                        return [1, (jQuery("#urlForTwit").val().length == 0 ? 140 : 92)];
                    } else {
                        return [0, Infinity];
                    }
                }
        ...
        submitHandler: function (form) {
            ...
            if (document.prgConnect_sendSocial.checkFacebook != undefined && document.prgConnect_sendSocial.checkFacebook.checked == true) {
                jQuery("#statusFacebookLoading").show("fast");
            }
            if (document.prgConnect_sendSocial.checkTwitter != undefined && document.prgConnect_sendSocial.checkTwitter.checked == true) {
                jQuery("#statusTwitterLoading").show("fast");
            }
            if (document.prgConnect_sendSocial.checkLinkedin != undefined && document.prgConnect_sendSocial.checkLinkedin.checked == true) {
                jQuery("#statusLinkedinLoading").show("fast");
            }
            if (document.prgConnect_sendSocial.checkTumblr != undefined && document.prgConnect_sendSocial.checkTumblr.checked == true) {
                jQuery("#statusTumblrLoading").show("fast");
            }
            if (document.prgConnect_sendSocial.checkStorify != undefined && document.prgConnect_sendSocial.checkStorify.checked == true) {
                jQuery("#statusStorifyLoading").show("fast");
            }
            if (document.prgConnect_sendSocial.checkPinterest != undefined && document.prgConnect_sendSocial.checkPinterest.checked == true) {
                jQuery("#statusPinterestLoading").show("fast");
            }
            if (document.prgConnect_sendSocial.checkFlickr != undefined && document.prgConnect_sendSocial.checkFlickr.checked == true) {
                jQuery("#statusFlickrLoading").show("fast");
            }
            if (document.prgConnect_sendSocial.checkXing != undefined && document.prgConnect_sendSocial.checkXing.checked == true) {
                jQuery("#statusXingLoading").show("fast");
            }
            if (document.prgConnect_sendSocial.checkDiigo != undefined && document.prgConnect_sendSocial.checkDiigo.checked == true) {
                jQuery("#statusDiigoLoading").show("fast");
            }
            if (document.prgConnect_sendSocial.checkGoogleplus != undefined && document.prgConnect_sendSocial.checkGoogleplus.checked == true) {
                jQuery("#statusGoogleplusLoading").show("fast");
            }

            jQuery.ajax({
                processData: false,
                url: "admin.php?prgPluginExtern=publishOnSN",
                type: "POST",
                dataType: "json",
                cache: false,
